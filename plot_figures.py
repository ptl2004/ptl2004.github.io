"""
PLOT_FIGURES.PY - Chức năng vẽ đồ thị từ simulation
"""
...
def plot_figure_6(metrics, model):
    ...
    plt.suptitle('Danh gia thuat toan dieu khien doi hinh hinh chu V', 
                fontsize=14, y=0.98)
    
    # Lưu file
    output_file = os.path.join('output', 'figure_6_paper_style.png')
...
def plot_trajectory(drones, model):
    ...
    # Lưu file
    output_file = os.path.join('output', 'formation_trajectory.png')
    plt.savefig(output_file, dpi=300, bbox_inches='tight')
